                ...
                <MDBCarouselItem className="active">
                    <MDBContainer style={{marginLeft:'-18px',}}>
                        <MDBRow className="  gx-4" >
                            <MDBCol lg="4"  md="4" sm="12"className="mb-5 mb-md-0">
                                <MDBCard bg="black" shadow="0" >
                                    <MDBCardBody className="gray-card d-flex flex-column justify-content-center align-items-center" style={{ height: '300px', width: '360px', borderRadius: '4px' }}>

                                        <h5 className="font-normal mt-4 " style={{ marginLeft: "-90px", fontFamily: "Montserrat, sans-serif", }}>Awesome Support!</h5>
                                        <p className="mb-3 " style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 300, fontSize: '12px', lineHeight: '26px', marginLeft: "-30px" }}>
                                        ...
                                        <div className="d-flex inline-flex" style={{ marginLeft: "-110px", }}>
                                            <img
